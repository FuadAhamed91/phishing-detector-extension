 ...
 *
 * Receives URLs from the content script and scores them with a purely local
 * heuristic engine: every URL starts at 100 and loses points for each risky
 * trait it exhibits. Nothing ever leaves the browser.
 */
'use strict';

const MESSAGE_TYPE = 'ANALYZE_URL';
const SAFE_THRESHOLD = 75; // score >= this is "safe", anything lower is "warning"
const MIN_SCORE = 1;
const MAX_SCORE = 100;
